...
import { Cloud, Lock, Mail, ArrowRight, ArrowLeft } from 'lucide-vue-next';
...
<template>
    <div class="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950 relative overflow-hidden">
