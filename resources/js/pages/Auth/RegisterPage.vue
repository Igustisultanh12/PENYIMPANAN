...
import { Cloud, Lock, Mail, User, Smartphone, ArrowRight } from 'lucide-vue-next';
    ...
    <div class="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-slate-950">
        <div class="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl shadow-xl p-8">
            ...
            <div class="text-center mb-6">
                ...
                <h2 class="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">Buat Akun MyStorage</h2>
                <p class="text-xs text-slate-400 mt-1">Dapatkan penyimpanan mandiri 10 GB gratis</p>
            </div>
